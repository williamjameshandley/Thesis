\documentclass[%
  ...
  draft,       % useful markings -- change to final when done
               %                    (or ms for a laugh)
]{memoir}
...
\include{commands/tools}     %tex tools
\include{commands/bayesian}  %Bayesian nomenclature
\include{commands/code}      %code
\include{commands/biblio}    %bibliographic
\include{commands/maths}     %maths
\include{commands/constants} %constants
%
