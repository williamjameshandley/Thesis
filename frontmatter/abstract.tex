...
\begin{center}
\Large\bfseries
Kinetic initial conditions for inflation: \\{\small Theory, observations and methods}\\ {\small William James Handley}
\end{center}
...
Chapter~\ref{chp:RK} demonstrates a new method for the efficient numerical solution of oscillatory ordinary differential equations, termed the Runge-Kutta-Wentzel-Kramers-Brillouin method, and has been submitted to the Journal of Computational Physics as~\cite{RKWKB}.
