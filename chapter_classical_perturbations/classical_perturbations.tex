...
\else
\begin{figure}
  \input{chapter_classical_perturbations/plots/swirl}
  \input{chapter_classical_perturbations/plots/true}
  \caption{Planckian initial conditions, here we can see\ldots}
\end{figure}

\begin{figure}
  \input{chapter_classical_perturbations/plots/swirl_alt}
  \input{chapter_classical_perturbations/plots/true_alt}
