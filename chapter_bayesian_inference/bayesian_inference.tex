...
\begin{figure}
  \centerline{%
    \input{chapter_bayesian_inference/plots/bayes_theorem}
  }
...
\begin{figure}
  ...
  \else
  \centerline{%
    \input{chapter_bayesian_inference/plots/beta_function}
  }
  \fi
  \caption{%
...
\begin{figure}
  ...
  \else
  \centerline{%
    \input{chapter_bayesian_inference/plots/1d_left_rectangle}
    \input{chapter_bayesian_inference/plots/2d_left_rectangle}
  }
  \fi
...
\begin{figure}
  \centering
  \input{chapter_bayesian_inference/plots/MH}
