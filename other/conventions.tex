...
\begin{itemize}
  \item I make significant use of symbolic overloading, using the same symbol in different contexts where their mathematical meaning is distinct, but their physical meaning is related. For example:
    \begin{enumerate}
