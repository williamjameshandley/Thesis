...
\end{equation} 
In most cases, we limit ourselves to adiabatic matter $\delta P_\en{en}=0$.
...
\section{Conclusions}
We have now covered all of the necessary background theory. Inflation's fundamental contribution to our model of the universe is that it predicts the primordial power spectrum $\mathcal{P}_\mathcal{R}(k)$ at some early time. The universe's accelerated expansion then freezes this to a specific value until much later, when we understand the physics in a lot more detail. We can then use these initial conditions set by inflation to make predictions about the sky that we see today.
