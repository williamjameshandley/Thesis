...
Using the notation in~(\ref{eqn:equation_of_state}) and defining the present-day densities $\{\rho_{i,0}\}$, the evolution equations~\eqref{eqn:Raychaudhuri_rho,eqn:conservation} take the form 
%
\begin{align}
  \dot{H}+H^2 &= 
