...
A na\"{\i}ve approach would be to use the approximate matched solution~\eqref{eqn:x_approxf} to create a stepping procedure analogous to the RK method~\eqref{eqn:y_step}~\&~\eqref{eqn:t_step}:
\begin{align}
